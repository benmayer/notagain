...
See [`documentation/GETTING_STARTED_GUIDE.md`](documentation/GETTING_STARTED_GUIDE.md) for a complete guide to all documentation.

### Core Documentation
- [Getting Started Guide](documentation/GETTING_STARTED_GUIDE.md) - Documentation overview and reading guide
- [Architecture](documentation/architecture.md) - Project structure and systems
- [Development Guide](documentation/DEVELOPMENT_GUIDE.md) - Common development tasks
- [Routing Guide](documentation/routing.md) - Navigation patterns (⚠️ **CRITICAL**)
- [State Management](documentation/state_management.md) - Provider pattern
- [Components](documentation/components.md) - UI system using Forui
- [Authentication](documentation/authentication.md) - Auth implementation
- [Database](documentation/database_schema.md) - Schema and models
- [Logging](documentation/logging.md) - Logging system
...
See [Development Guide](documentation/DEVELOPMENT_GUIDE.md) → "Adding a New Screen"
...
**Full guide:** [Routing Guide](documentation/routing.md)
...
**Ready to code?**
→ Start with [Getting Started Guide](documentation/GETTING_STARTED_GUIDE.md)
→ Then read [Development Guide](documentation/DEVELOPMENT_GUIDE.md)
→ Always review [Routing Guide](documentation/routing.md) before touching navigation code
