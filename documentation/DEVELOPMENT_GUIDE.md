...
Ensure you've completed [GETTING_STARTED_GUIDE.md](GETTING_STARTED_GUIDE.md):
...
**See also:** [logging.md](logging.md)
...
**Common issue:** Stack corruption ("popped last page") - see [routing.md](routing.md)
...
- **Learn routing patterns:** [routing.md](routing.md)
